package com.speakercleaner.volume.booster.loud.music.volumeBooster.utils
...
import com.hmd.permissionslib.R
import com.hmd.permissionslib.databinding.PermissionSettingDialogBinding
import com.hmd.permissionslib.databinding.PermissionxPermissionItemBinding
...
) : Dialog(context, R.style.PermissionDefaultDialog) {

    private lateinit var binding: PermissionSettingDialogBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = PermissionSettingDialogBinding.inflate(layoutInflater)
